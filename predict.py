...
def app(car_df):
	...
	if st.button("Predict"):
		...
		st.info("R2 score of this model is: {:2.2%}".format(car_r2))
		st.info("Mae score of this model is: {:2.2%}".format(car_mae))
		st.info("Msle score of this model is: {:2.2%}".format(car_msle))
		st.info("Rmse score of this model is: {:2.2%}".format(car_rmse))
